          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              ...
              window.setTimeout(function () {
                location.assign('/'); //Used to assign a particular page 'home page' in this case
              }, 1500);
            }
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            //If logged out then reload else user menu will work with previous user which it will find in cache
...
var logOutBtn = document.querySelector('.nav__el--logout'); //got from '_header.pug'
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value; //Ids as mentioned in login.pub

  var password = document.getElementById('password').value; //Ids as mentioned in login.pub
